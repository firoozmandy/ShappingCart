...
export default function Navbar() {
  ...
  return (
    <div className=" fixed z-20 bg-gray-200 shadow-sm mb-3 items-center w-full flex flex-grow ">
      ...
      <div className="flex md:flex-grow flex-row  justify-end md:mx-7 sm:mx-96 mx-4 gap-4 md:gap-8 items-center">
        <NavLink
          to="/Nini"
        ...
        {cartQuantity > 0 && (
          <Button
            onClick={openCart}
            className=" md:w-10 rounded-full w-7 h-7 md:h-10	flex items-center justify-center hover:bg-gray-200 hover:transition delay-200 duration-300 	"
          >
